...
public interface RedisCacheManager<T> {
     ...
     * @return 处理结果
     */
    RedisCacheResult<T> saveValue(RedisCacheParam<T> request);
     ...
     */
    RedisCacheResult<T> getValue(RedisCacheParam<T> request);
     ...
     * @return 处理结果
     */
    RedisCacheResult<T> removeValue(RedisCacheParam<T> request);
     ...
     */
    RedisCacheResult<T> listValuesByList(RedisCacheParam<T> request);
}
